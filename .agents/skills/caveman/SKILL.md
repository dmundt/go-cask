...
Vendored, adapted for go-cask from the MIT-licensed
[JuliusBrussee/caveman](https://github.com/JuliusBrussee/caveman) skill at
`skills/caveman/SKILL.md` (revision `880114a42067d045b91dffe6a553f6ab2cc399ad`,
blob `31b0c7c8a43cbfd1998d5406f5f56dfa17b8545d`). Copyright (c) 2026 Julius
Brussee, MIT — see the repository [`LICENSE`](/LICENSE) and
[`NOTICE`](NOTICE). When upstream changes, re-vendor and update this block
rather than editing the rules below in place.

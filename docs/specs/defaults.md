...
| Object serialization envelope     | TLV envelope `[version u8][uvarint typeLen][type][uvarint payloadLen][payload]` | cas-core §8, decision 1 |
...
| Library baseline              | Go 1.22+ (generics, enhanced routing; toolchain self-managing)                 | library-design §5    |
